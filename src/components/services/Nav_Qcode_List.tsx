...
import { useRead_After_Date_Services } from "hooks/ajax_crud/useAjax_Read" ;
...
const Nav_Qcode_List = ( ) => {
    ...
    useEffect( () => { 
        ...
        const filter_Date_Services_1 = date_Services_1.filter( ( x:any ) => ( x['service_status'] !== '當日住宿' && x['service_status'] !== '預約住宿' ) ) as any ;
        const filter_Date_Services_2 = date_Services_2.filter( ( x:any ) => ( x['service_status'] !== '當日住宿' && x['service_status'] !== '預約住宿' ) ) as any ;
        const filter_Date_Services_3 = date_Services_3.filter( ( x:any ) => ( x['service_status'] !== '當日住宿' && x['service_status'] !== '預約住宿' ) ) as any ;
