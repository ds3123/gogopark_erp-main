...
{ /* 員工表單欄位  */ }
const Employee_Form = ( { register  , errors , setValue , current , control , editType , employeeData } : IEmployee ) => {
    ...
    const all_Accounts = useFetch_Shop_Accounts() ;
    ...
    useEffect( () => {
       ...
       setValue( "employee_Shop_Account" , shop_Id , { shouldValidate : true , shouldDirty : true }  ) ; 
    ...
    return <>
                ...
                <div className="columns is-multiline is-mobile m_Bottom_30">
                    ...
                    <div className="column is-12-desktop"> 
                        ...
                        <p className="m_Top_50"> 所屬商店 &nbsp; <b className = "fRed" > { errors.pet_Species?.message } </b> </p>
                        
                        <div className="control has-icons-left relative">

                            <span className="absolute required" style={{ top:"-40px" , left:"-10px" }}></span>

                            <div className="select">

                                <select value = { s_Id }  { ...register( "employee_Shop_Account" ) }>
                                    ...
                                    {  
                                       all_Accounts.map( ( x : any , y : number ) => {
                                           ...
                                           return <option key = { y } value = { x['account_id'] } > 
                                                        ...
                                                        { x['shop_name'] }&nbsp; 
                                                        ( { x['county'] } / { x['district'] } / { x['zipcode'] }-{ x['shop_num'] } ) 
                            ...
                            <div className="icon is-small is-left"> <i className="fas fa-store"></i> </div>
                ...
                <>
                    ...
                    { /* 帳號資料 */ }
                    <label className="label" style={{ fontSize : "1.3em" }}> <i className="fas fa-user"></i> &nbsp; 個人資料 </label> <br/>
