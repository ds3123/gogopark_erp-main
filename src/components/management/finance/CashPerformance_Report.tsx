...
const CashPerformance_Report = () => {
  ...
  return <div className = "m_Bottom_200" >
            ...
            <Title_Folder tag_Color = "is-warning" service_Type = "洗澡美容" amount_Type = "扣 _ 預收款" amount_Total = { total_Obj.Deduct_Advance }  >
                <Deduct_Advance_Receipt_Table data = { data_Obj.use_Plan_Data } />
            </Title_Folder>
