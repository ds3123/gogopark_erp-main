...
// @表單內容 : 綜合報表
const Unity_Table_Content = ( { data_Obj } : { data_Obj : I_Finance_Section_1 } ) => {
     ...
     return <>   
                 ...
                 { is_folding_Receivable && <Service_Receivable_Table data = { data_Obj.service_Data.concat( data_Obj.extra_Fee_By_PaymentDate ) } />  }
                 ...
                 { is_folding_MinusPrepayment && <Deduct_Advance_Receipt_Table  data={ data_Obj.use_Plan_Data } /> }
                 ...
                 { is_folding_Prepayment && <Advance_Receipt_Table data={ data_Obj.plan_Data } /> }
                 ...
                 { is_folding_LodgeCare && <Lodge_Receivable_Table data={ data_Obj.care_Lodge_Data } /> }
                 ...
                 { is_folding_Other_Income &&  <Other_Cash_Income_Table data={ data_Obj.others_By_Date } />  }
                 ...
                 { is_folding_Other_Expenditure && <Other_Cash_Expenditure_Table data={ data_Obj.others_By_Date } /> }
...
export default Unity_Table_Content
